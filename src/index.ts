...
// various `register*Tool` helpers make. We combine that dynamic list with the
// hand-rolled Sequential Thinking tool (which is not registered through the
// helper API because we handle it manually in the CallTool handler).
const allTools: Tool[] = [
  SEQUENTIAL_THINKING_TOOL,
  ...Object.values((server as any).capabilities.tools as Record<string, Tool>)
];
